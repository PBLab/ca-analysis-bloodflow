...
class FovDataContainer:
    ...
    def __attrs_post_init__(self):
        ...
        if self.labeled.loaded is None:
            self.labeled.load_data()
        if self.unlabeled.loaded in None:
            self.unlabeled.load_data()
...
if __name__ == "__main__":
    ...
    fovs = []
    resfile = foldername / '355_GCaMP6-Ch2_WFA-590-Ch1_X25_mag3_act3b-940nm_256px_20180313_00001_CHANNEL_2_results.npz'
    colabel_img = foldername / ''
